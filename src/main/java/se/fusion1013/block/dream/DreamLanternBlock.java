...
public class DreamLanternBlock extends AbstractDreamLightBlock {

    public static final MapCodec<DreamLanternBlock> CODEC = createCodec(DreamLanternBlock::new);
    ...
    public DreamLanternBlock(Settings settings) {
    ...
    public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
        return new DreamLanternBlockEntity(pos, state);
    }
