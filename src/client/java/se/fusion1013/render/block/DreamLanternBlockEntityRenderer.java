...
public class DreamLanternBlockEntityRenderer implements BlockEntityRenderer<DreamLanternBlockEntity> {
    ...
    private static final float POINT_LIGHT_MAX_BRIGHTNESS = 1.4f;
    private static final Vector3f DEFAULT_LIGHT_COLOR = new Vector3f(50/255f, 123/255f, 168/255f);

    public DreamLanternBlockEntityRenderer(BlockEntityRendererFactory.Context ctx) {}

    @Override
    public void render(DreamLanternBlockEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
    ...
    private void renderLights(DreamLanternBlockEntity entity, BlockState state, float tickDelta) {
        if (!entity.isRemoved()) {
    ...
    private void updatePointLight(DreamLanternBlockEntity entity, boolean lit, float tickDelta, BlockState state) {
    ...
    private PointLight createPointLight(DreamLanternBlockEntity entity) {
    ...
    private Vec3d getCenterPosition(DreamLanternBlockEntity entity) {
